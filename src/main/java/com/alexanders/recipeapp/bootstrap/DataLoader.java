package com.alexanders.recipeapp.bootstrap;
...
import com.alexanders.recipeapp.domain.Difficulty;
import com.alexanders.recipeapp.domain.Ingredient;
import com.alexanders.recipeapp.domain.Notes;
...
import com.alexanders.recipeapp.repositories.UnitOfMeasureRepository;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setDirections(
                "1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the " +
                        "flesh with a spoon" +
                        "\n" +
                        ...
                        "Remember that much of this is done to taste because of the variability in the fresh ingredients. Start with this recipe and adjust " +
                        "to your taste.\n" +
        ...
        guacNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
                                         ...
                                         "Kennedy favorite). Try guacamole with added pineapple, mango, or strawberries.\n" +
                                         ...
                                         "To extend a limited supply of avocados, add either sour cream or cottage cheese to your guacamole dip. Purists may " +
...
//        guacNotes.setRecipe(guacRecipe);
        ...
        tacosRecipe.setDirections("1 Prepare a gas or charcoal grill for medium-high, direct heat.\n" +
                                          ...
                                          "salt, garlic and orange zest. Stir in the orange juice and olive oil to make a loose paste. Add the chicken to the" +
                                          " bowl and toss to coat all over.\n" +
                                          "Set aside to marinate while the grill heats and you prepare the rest of the toppings.\n" +
                                          "\n" +
                                          "\n" +
                                          "3 Grill the chicken: Grill the chicken for 3 to 4 minutes per side, or until a thermometer inserted into the " +
                                          "thickest part of the meat registers 165F. Transfer to a plate and rest for 5 minutes.\n" +
                                          "4 Warm the tortillas: Place each tortilla on the grill or on a hot, dry skillet over medium-high heat. As soon as " +
                                          "you see pockets of the air start to puff up in the tortilla, turn it with tongs and heat for a few seconds on the " +
                                          "other side.\n" +
                                          ...
                                          "chicken slices, sliced avocado, radishes, tomatoes, and onion slices. Drizzle with the thinned sour cream. Serve " +
                                          "with lime wedges.\n" +
                                          "\n" +
                                          "\n" +
        ...
        tacoNotes.setRecipeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
                                         "Any and every kind of leftover can go inside a warm tortilla, usually with a healthy dose of pickled jalapenos. I " +
                                         "can always sniff out a late-night snacker when the aroma of tortillas heating in a hot pan on the stove comes " +
                                         ...
                                         "Grill the chicken, then let it rest while you warm the tortillas. Now you are ready to assemble the tacos and dig " +
                                         "in. The whole meal comes together in about 30 minutes!\n" +
                                         "\n" +
                                         "\n" +
